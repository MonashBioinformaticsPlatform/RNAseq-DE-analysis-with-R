...
#HOMEDIR <- "/mnt/vicnode/mbp/market/servers/bioinformatics-platform/home/roxane"
HOMEDIR <- "/mnt/home/roxane"

# define your working directory for the RNAseq data analysis
RNASeqDIR <- file.path(HOMEDIR,"RNAseq")

load(file.path(RNASeqDIR,"RNAseq_DE_analysis_with_R.RData"))
```
